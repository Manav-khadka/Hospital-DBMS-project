...
def mgmnt():
    if entry_username.get()=="Admin" and entry_password.get()=="1234":
        ...
        def login2():
            ...
            entry_pass=Entry(mysqlhosting,font=("times new roman",20),textvariable=p,bg="light green")
    ...
    # ================================================================================================================
        ...
        # ------------------------------------------------search function----------------------------------------------
                def search():
                    ...
                    lbl_search=Label(search,font=("times new roman",25,),text="Patient ID:-")
                    lbl_search.place(x=140,y=30)
                    s=StringVar()
                    entry_search=Entry(search,font=("times new roman",25),textvariable=s)
                    ...
                    def show():
                        ...
                        for record in trv.get_children():
                            trv.delete(record)
                        s1=entry_search.get()
                        my_cursor.execute("SELECT * FROM patient_details WHERE Patient_ID LIKE '%"+s1+"%'"  )
                    ...
                    btn_search=Button(search,text="Search",font=("times new roman",20),command=show)
                ...
                def delete():# function for delete selected data of ptient
                    if pn.get()=="" or id.get()=="":
                        ...
                        my_cursor.execute("""DELETE FROM patient_details WHERE Patient_ID=%s""",(entry_patient_id.get(),)  )
                        conn.commit()
                        fetch_data()
                        entry_patient_name.delete(0,END)
                        entry_patient_id.delete(0,END)
                ...
                def save(): #function to save the patient data record
                    insert_stmt = (
                                "INSERT INTO patient_details(  Patient_ID,Patient_name, Age, Disease_Name, Medicine_Name, Blood_pressure,Blood_group,Medication,Checked_by,Contact_NO)"
    ...
    # ========================================= button ===========================================================================================================================
        ...
        # =================================search==============================================
                ...
                root.mainloop()
            btn_mysql=Button(mysqlhosting,text="LOGIN",font=("times new roman",20,"bold"),command=patient,bg="blue",fg="white")
        ...
        btn_patient_mgmnt=Button(management,image=img_patient_mgmnt,borderwidth=0,command=login2)
