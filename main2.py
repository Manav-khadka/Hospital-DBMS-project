...
conn = mysql.connector.connect(
       host="sql6.freemysqlhosting.net", username="sql6468766", password="rBwxUpSJhe", database="sql6468766")
...
def save(): 
        ...
        insert_stmt = (
            "INSERT INTO first( Patient_name, Patient_ID, Age, Disease_Name, Medicine_Name, Blood_pressure,Blood_group,Medication,Checked_by,Contact_NO)"
            "VALUES (%s, %s, %s, %s ,%s,%s,%s,%s,%s,%s)")
        data = (pn.get(),   id.get(),   age.get(),   dn.get(),   mn.get(
...
trv.heading("1", text="Patient name")
trv.heading("2", text="Patient id")
trv.heading("3", text="Age")
trv.heading("4", text="Disease name")
trv.heading("5", text="medicine name")
trv.heading("6", text="Blood Pressure")
trv.heading("7", text="Blood group")
trv.heading("8", text="Medication")
trv.heading("9", text="Checked by")
trv.heading("10", text="Contact No.")
trv['show'] = 'headings'
...
def get_cursor():
    ...
    entry_patient_name.insert(0,values[0])
    entry_patient_id.insert(1,values[1])
